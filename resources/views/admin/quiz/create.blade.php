            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        @if (isset($data))
                            <form method="POST" action="{{ route('quiz.update', $data['title']->id) }}" id="quiz-form" enctype="multipart/form-data">
                                @method('PUT')
                        @else
                            <form method="POST" action="{{ route('quiz.store') }}" id="quiz-form" enctype="multipart/form-data">
                        @endif
                            @csrf
                            <div class="card-body">
            ...
            <div class="card card-secondary mb-3" id="question-${questionCount}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="question-${questionCount}-title" name="questions[${questionCount}][question]" value="${questionData ? questionData.question : ''}" placeholder="Enter Question">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control  type-select" id="question-${questionCount}-type" name="questions[${questionCount}][type]">
